...
send(msg.chat_id_, msg.id_, "• 🇸🇦  تم مـسح  قائمة الادامن  ")
end
...
Reply_Status(msg,msg.sender_user_id_,"lock","• 🇸🇦 تم قفـل الفارسية")  
end
...
Reply_Status(msg,msg.sender_user_id_,"lock","• 🇸🇦  تـم فـتح الفارسية\n")  
end
...
Namebot = (database:get(bot_id.."source:Name:Bot") or "كيان")
local namebot = {
"اسمي حامي الحمى "..Namebot.. "",
"اسمي المتألق "..Namebot.. "",
"اسمي المبدع "..Namebot.. "",
"اسمي وزير الأمن "..Namebot.. "",
"اسمي معالي "..Namebot.. "",
"حبيبي اسمي "..Namebot.. "",
"راجعنا بعد شهر ؟ "
}
...
[[
- ايديڪ  ⁞ #id 💘 ٬
- يوزرڪ حامي الحمى ⁞ #username 💘 ٬
- رسائلڪ  وزير الأمنهہَ ⁞ #msgs 💘 ٬
- رتبتڪ الحلوه ⁞ #stast  💘٬
- سحڪاتڪ الفول ⁞ #edit 💘 ٬
]]}
...
os.execute('wget https://raw.githubusercontent.com/Yosef-lbban/source/master/source.lua')
os.execute('wget https://raw.githubusercontent.com/Yosef-lbban/source/master/start.lua')
dofile('source.lua')  
return false
end
...
rpl = {"نعم ﺣحب 💓"," ﮪݪـﯛ عمري تفضل💕","ها حبب قول؟ ","زحفتلك قول وش تبي 😂🙂","هها موكلت 💓🥺","راسلتك 👋🏼😂"};
...
if Devsource(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/Yosef-lbban/files_source/master/getfile.json")
if res == 200 then
...
local json_file, res = https.request("https://raw.githubusercontent.com/Yosef-lbban/files_source/master/files_source/"..file)
if res == 200 then
